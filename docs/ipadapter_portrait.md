...
│                                                                  │
│  ┌────────────────────┐                                          │
│  │ ① CheckpointLoader  │  Animagine XL 4.0 (SDXL 动漫)           │
│  │    Simple           │                                         │
│  └──┬────────┬───────┬┘                                          │
│     │MODEL   │CLIP   │VAE                                         │
│     │        │       │                                            │
...
│  ┌──────────────────┐│       ┌──────────┐                        │
│  │ ③ IPAdapter       ││       │ ② 参考脸  │                        │
│  │   UnifiedLoader  ││       │ LoadImage│                        │
│  │   PLUS preset    ││       │ (你的照片)│                        │
│  └──┬──────┬────────┘│       └────┬─────┘                        │
│     │MODEL │IPADAPTER │            │IMAGE                          │
│     │      │          │            │                               │
│     ▼      ▼          │            ▼                               │
│  ┌────────────────────────────┐                                   │
│  │ ④ IPAdapterAdvanced        │                                   │
│  │ weight=0.75                │  ← 控制人脸相似度                  │
│  │ combine_embeds=concat      │  ← 消除波浪纹                      │
│  │ embeds_scaling=K+V         │  ← 平滑注入                        │
...
│                       └────┘ └────┘                    │
│                                                        │
│  ⚠️ Prompt 只写服装/场景/风格, 不写脸!                     │
│  显存: 10-14GB │ 速度: 中等 (~25秒/张)                     │
└──────────────────────────────────────────────────────────┘
```
